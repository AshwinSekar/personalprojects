...
public class RightHandFollower extends MazeSolver implements Runnable {

	public RightHandFollower(byte maze[][]) {
		super(maze);
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		RightHandFollower solver = new RightHandFollower(hi.generate());
